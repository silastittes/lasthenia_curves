...
pcex <- 2
mtext(text = "A", side = 3, adj = 0, cex = pcex, line = 0.5)
...
axis(side = 1, labels = F)
axis(side = 2, labels = F)
mtext(text = "B", side = 3, adj = 0, cex = pcex, line = 0.5)
...
axis(side = 1, labels = F)
axis(side = 2, labels = F)
mtext(text = "C", side = 3, adj = 0, cex = pcex, line = 0.5)
...
axis(side = 1, labels = F)
axis(side = 2, labels = F)
mtext(text = "D", side = 3, adj = 0, cex = pcex, line = 0.5)
