...
#DRAWS USED FOR BOTH REGRESSIONS--------------------
sub_draws <- 500
draw_n <- sample(1:ndraws, sub_draws, replace = F)
...
summ_lasso <- function(df){
  df %>% 
    ...
    mutate(" " = c("coefficient mean", "prop. draws $>$ 0", "sign bias ratio", "proportion of draws $=$ 0")) 
}
